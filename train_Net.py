...
parser.add_argument('--rgb_root', type=str, default='/test_maps/train_dut/',
                    help='the training rgb images root')  # train_dut
parser.add_argument('--depth_root', type=str, default='/test_maps/train_dut/',
                    help='the training depth images root')
parser.add_argument('--gt_root', type=str, default='/test_maps/train_masks/',
                    help='the training gt images root')

parser.add_argument('--val_rgb', type=str, default="/test_datasets/NLPR/RGB/",
                    help='validate rgb path')
parser.add_argument('--val_depth', type=str, default="/test_datasets/NLPR/depth/",
                    help='validate depth path')
parser.add_argument('--val_gt', type=str, default="/test_datasets/NLPR/GT/",
