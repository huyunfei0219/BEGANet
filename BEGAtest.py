...
parser.add_argument('--test_path', type=str, default='./test_maps/test_datasets/test_datasets/', help='test dataset path')
parser.add_argument('--save_path', type=str, default='./test_maps/MAGNet/', help='save path')
parser.add_argument('--pth_path', type=str, default='./ckps/MAGNet/Net_rgb_d_epoch_160.pth', help='checkpoint path')
